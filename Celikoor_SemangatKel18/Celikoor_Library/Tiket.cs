    ...
    class Tiket
    {
        ...
        public static List<Tiket> BacaData(string kriteria, string nilaiKriteria)
        {
            ...
            while (result.Read())
            {
                ...
                tmpUser.Id_Konsumen = result.GetInt32("pembelis_id");
                tmpUser.Nama_Konsumen = result.GetString("nama");
        ...
        public static bool InsertTiket(Tiket tiket)
        {
            ...
            string sql = "INSERT INTO tikets(tgl_beli, slot_jadwal, no_kursi, ruang_bioskop, films_id, pembelis_id, status) " +
                " VALUES (NOW()," + tiket.SlotJadwal + "," + tiket.NoKursi + "," + tiket.RuangBioskop + "," + tiket.DataFilm.Id + "," + tiket.User.Id_Konsumen + ",'PROSES');";
